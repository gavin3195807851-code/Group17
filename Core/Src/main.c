...
int main(void)
{
    ...
    // Startup animation
    LCD_Fill_Buffer(0);
    LCD_printString("Group 17", 55, 30, 1, 3);
    LCD_printString("Guojia Yin", 35, 85, 1, 2);
    LCD_printString("Zhengyi Li", 35, 115, 1, 2);
    LCD_printString("Zilin Zhuang", 25, 145, 1, 2);
    LCD_printString("Loading...", 50, 200, 1, 2);
    LCD_Refresh(&cfg0);
    HAL_Delay(3500);
